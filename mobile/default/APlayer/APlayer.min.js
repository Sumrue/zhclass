...
APlayer.prototype.init = function() {
    ...
    if (this.element.innerHTML = '<div class="aplayer-pic"><img id="aplayer-pic-img" src="' + this.music.pic + '"><div class="aplayer-button aplayer-pause aplayer-hide"><i class="demo-icon aplayer-icon-pause"></i></div><div class="aplayer-button aplayer-play"><i class="demo-icon aplayer-icon-play"></i></div></div><div class="aplayer-info"><div class="aplayer-music"><span class="aplayer-title">' + this.music.title + '</span><span class="aplayer-author"> - 加载中...</span></div><div class="aplayer-lrc"><div class="aplayer-lrc-contents" style="transform: translateY(0);"></div></div><div class="aplayer-controller"><div class="aplayer-bar-wrap"><div class="aplayer-bar"><div class="aplayer-loaded" style="width: 0"></div><div class="aplayer-played" style="width: 0"><span class="aplayer-thumb"></span></div></div></div><div class="aplayer-time"><input type="hidden" id="current-ptime" class="current-ptime" value="0" /><span class="aplayer-ptime">00:00</span> / <span class="aplayer-dtime">00:00</span><div class="aplayer-volume-wrap"><i class="demo-icon aplayer-icon-volume-down"></i><div class="aplayer-volume-bar-wrap"><div class="aplayer-volume-bar"><div class="aplayer-volume" style="height: 80%"></div></div></div></div></div></div></div>', this.option.showlrc) {
...
APlayer.prototype.play = function() {
	...
	$("#aplayer-pic-img").addClass("playing"),
    this.audio.play();
    var e = this;
    this.playedTime = setInterval(function() {
		...
		document.getElementById("current-ptime").value = Math.floor(e.audio.currentTime)
    },
    100)
},
APlayer.prototype.pause = function() {
	...
	$("#aplayer-pic-img").removeClass("playing"),
    this.audio.pause(),
